...
`--event` supports `push`, `pull_request`, `merge_group`, `release`, `deployment`, `deployment_status`, `create`, `delete`, `label`, `fork`, `public`, `gollum`, `page_build`, `watch`, `milestone`, `issues`,
...
- `GITHUB_EVENT_NAME`: `push`, `pull_request`, `issues`, `issue_comment`,
  ...
  `deployment`, `deployment_status`, `create`, `delete`, `label`, `fork`, `public`, `gollum`, `page_build`, `watch`, or `milestone`
...
`deployment`, `deployment_status`, `create`, `delete`, `label`, `fork`, `public`, `gollum`, `page_build`, `watch`, `milestone`, `issues`, `issue_comment`, and PR review events without native event settings. Merge
