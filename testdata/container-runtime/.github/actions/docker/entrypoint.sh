...
printf '%s\n' 'CONTAINER_RUNTIME_DOCKER_ENV=seen' >> "$GITHUB_ENV"
printf '%s\n' 'container runtime Docker action summary' >> "$GITHUB_STEP_SUMMARY"
printf '%s\n' '::add-mask::container-runtime-docker-secret'
printf '%s\n' 'masked Docker probe: container-runtime-docker-secret'
