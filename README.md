...
| Background, wait, cancellation, and parallel step controls; Linux job and service containers | Implicit private-registry authentication, container hooks, or any Docker use on macOS |
