...
| Background, wait, cancellation, and parallel step controls; bounded Linux job and service containers | Private container images, custom container options, or any Docker use on macOS |
